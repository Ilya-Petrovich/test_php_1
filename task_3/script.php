...
function createOrder($event_id, $event_date, $ticket_adult_price, 
	...
	// соединение с БД используется здесь только для проверки работоспособности кода
	// при непосредственной реализации необходимо вынести в соответствующее место
	...
	for ($i = 0; $i < $n; $i++) {
		// выбрал самый простой способ генерации случайного числа, так как отсутствовали
		// особые требования, другим возможным вариантом может быть использование хэша
		# generating barcode
